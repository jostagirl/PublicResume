...
<strong>Senior Systems and Product Operations Lead | Platform Reliability | Technical Program Contributor</strong><br/>
Nevada City, CA<br/>
...
#### Core Expertise and Technical Foundations
- Product and Engineering Operations Alignment
- Platform Reliability, Integration Quality, and Deployment Readiness
- Systems Thinking Across Distributed Platforms and Data Pipelines
- Cross-Functional Program Execution and Delivery Coordination
- Data Quality, Integrity, and Performance Monitoring
- Workflow Design, Documentation, and Escalation Frameworks
- Python and SQL for diagnostics, analysis, and workflow automation
- Cloud ingestion pipelines, telemetry and event data, system monitoring
- Git-based workflows and command-line tooling
...
- Supported data acquisition and hosted platform services, ensuring availability, data integrity, and reliable system operation.
- Provided advanced troubleshooting across data, network, and application layers in time-sensitive operational environments.
- Supported internal infrastructure and platform transitions while maintaining service continuity.
